...
public class SingleWorldListener implements Listener {
    ...
    public SingleWorldListener(Plugin plugin) throws Exception {
        ...
        try {
            this.done = classChunk.getField("done", "field_76646_k").getRealField();
            this.lit = classChunk.getField("lit", "field_150814_l").getRealField();
            this.s = classChunk.getField("s", "field_111204_q").getRealField();
        } catch (Throwable e) {
            e.printStackTrace();
        }
